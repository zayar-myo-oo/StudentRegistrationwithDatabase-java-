            ...
            <div class="main_contents">
                <div id="sub_content">
                    ...
                    <div class="row mb-4">
                     ...
                     <p class="col-md-3 text-danger">${error}</p>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-2"></div>
                            <label for="username" class="col-md-2 col-form-label">UseName</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="usename" value="" name="name">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-2"></div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="btn btn-secondary col-md-2 addsubmits"
