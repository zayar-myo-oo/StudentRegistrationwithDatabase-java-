          ...
          <a href="DisplayStudentServlet">Student Search </a>
            ...
            <div class="main_contents">
                <div id="sub_content">
                    ...
                    <form action=CouserRegister method="post">
						<div class="row mb-4">
                        <h2 class="col-md-3 offset-md-2 mb-5 mt-4">Course Registration</h2>
                     <p class="col-md-3 text-danger">${errorCu}</p>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="courseid" value="STU<%=count %>" name="courseId">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="coursename" value="" name="courseName">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <button type="submit" class="btn btn-secondary col-md-2 addsubmits" data-bs-toggle="modal"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                >Registered Succesfully !</h5>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-success col-md-2" id="okbtns"
...
<script src="courseapp.js"></script>
